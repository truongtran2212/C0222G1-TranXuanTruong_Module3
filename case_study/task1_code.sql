...
-- INSERT into hop_dong_chi_tiet (so_luong,id_hop_dong,id_dich_vu_di_kem) values (3,2,2);
-- INSERT into hop_dong_chi_tiet (so_luong,id_hop_dong,id_dich_vu_di_kem) values (2,6,1);
